...
def main():
    ...
    initial_memory_texts = [
        "ガンダムとは、宇宙世紀を舞台にした人間ドラマである。そして進化しようとしている人間たちの悲劇のドラマでもある。",
        "インドカレーはスパイスの芸術品だ。",
        "高機能なスポーツウェアは、もはや第二の皮膚と言える。しかしちょこっとだけお高い。",
        "AIの進化は、人間の知性を拡張する。しかし残酷な側面もあり、個人の能力、テクノロジーとの適合性を極端に顕在化させる鏡でもある。",
        "猫は液体であり、宇宙の真理を知っている。そしてチュールを毎日決まった時間に取りに来るのである。",
        "磐田市のうなぎは最高に美味い。私は蒲焼きうな重派だ。",
        "名古屋のひつまぶしは、うなぎの食べ方の芸術である。白焼きのウナギを薬味と出汁を駆使して、三段階で楽しむ。",
        "プログラミングとは、世界を再定義する行為だ。自らのタクトで、世界を構築することができる。",
        "人生における大切なことは、だいたいサウナと水風呂が教えてくれる。",
        "雨の日に聞くジャズは、心を落ち着かせる。",
        "豪雨の日に聞くジャズは、だいたい何も聞こえない。。。（笑）",
        "本当に良い設計は、引き算から生まれる。"
    ]
    ...
    try:
        while True:
            ...
            # 2. RSRAGで過去の記憶を検索
            # method = exploratory / standard
            # ruminate = True / False
            search_results = srag_eng.search(q_cube, hub, method="exploratory", ruminate=True)
